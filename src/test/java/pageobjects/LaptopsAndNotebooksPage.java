...
public class LaptopsAndNotebooksPage extends BasePage{
	...
	//Validation
	public String twoLaptopsWereAdded() {
		sleep(700);
		return getText(numberOfLaptopsInCart);
	}

	//Validation
	public String oneLaptopWasRemoved() {
		sleep(700);
		return getText(numberOfLaptopsInCart);
	}

	//Validation 
	public String allLaptopsWereAdded() {
		sleep(700);
		return getText(numberOfLaptopsInCart);
	}

	//Validation
	public String allLaptopsWereRemoved() {
		sleep(700);
		return getText(numberOfLaptopsInCart);
	}

	//Validation
	public String oneLaptopWasAdded() {
		sleep(700);
		return getText(numberOfLaptopsInCart);
	}

	//Validation
	public String threeLaptopWasAdded() {
		sleep(700);
		return getText(numberOfLaptopsInCart);
	}

	//Validation
	public String twoLaptopsWereAddedToComparison() {
		sleep(700);
		return getText(numberOfLaptopsInComparison);
	}
